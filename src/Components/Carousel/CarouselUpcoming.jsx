...
import Card from '../Cards/CardUpcoming';
    ...
    <Slider {...settings}>
      {slides.map((slide, index) => (
        <div key={index} className="carousel-card">
          <Card image={slide.image} title={slide.title} date={slide.date} venue={slide.venue} description={slide.description} register={slide.register} />
        </div>
      ))}
    </Slider>
  );
