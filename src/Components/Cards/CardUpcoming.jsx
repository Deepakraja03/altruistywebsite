...
const CardUpcoming = ({ image, title, date, venue, description, register }) => {
  return (
    <div className="bg-white rounded-xl mx-5 md:gap-3 md:h-96 md:w-64 shadow-md overflow-hidden">
      ...
      <div className="p-2 flex flex-col justify-center">
        ...
        <p className="text-sm text-gray-600 mb-1"><span className='font-semibold text-black'>Venue:</span> {venue}</p>
