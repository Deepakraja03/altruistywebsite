...
const CardJobs = ({ image, title, location, salary, type, description, register }) => {
  return (
    <div className="bg-white rounded-xl mx-5 md:gap-3 md:h-96 md:w-64 shadow-md overflow-hidden">
      ...
      <div className="p-2 flex flex-col justify-center">
        ...
        <p className="text-sm text-gray-600 mb-1"><span className='font-semibold text-black'>Salary:</span> {salary}</p>
        <p className="text-sm text-gray-800 mb-1"><span className='font-semibold text-black'>Type:</span> {type}</p>
        <p className="text-sm text-gray-800 mb-1"><span className='font-semibold text-black'>Description:</span> {description}</p>
